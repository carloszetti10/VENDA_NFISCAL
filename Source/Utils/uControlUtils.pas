...
uses
  Vcl.StdCtrls, Vcl.Mask, Vcl.ComCtrls, Vcl.Controls,Vcl.ExtCtrls,RxCurrEdit,Vcl.CheckLst;
type
TControlUtils = class
...
begin
  ...
  begin
    ...
    if Parent.Controls[i] is TCheckListBox then
      TCheckListBox(Parent.Controls[i]).Enabled := Habilitar;
