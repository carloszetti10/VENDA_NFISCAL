...
uses
  ...
  ZAbstractRODataset, ZAbstractDataset, ZDataset, uValidarCampo, uAppServiceConexao;
...
type
  ...
  protected
    ...
    procedure HabilitarCampos(Habilitar: Boolean); virtual; abstract;
    procedure Iniciar;
  ...
  public
    ...
    function GetIdSelecionado: Integer; virtual;
  end;
...
begin
  TValidarCampos.ValidarCampoVazio(mskPesquisar, 'Campo Pesquisa');
  Pesquisa;
...
function TfrmTelaBaseCadastro.GetIdSelecionado: Integer;
begin
  Result := Qry.Fields[0].AsInteger; // pegar ID
end;
